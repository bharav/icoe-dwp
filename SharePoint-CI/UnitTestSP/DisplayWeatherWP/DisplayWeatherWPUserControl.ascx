...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DisplayWeatherWPUserControl.ascx.cs" Inherits="ICOE.CI.SP.DisplayWeatherWP.DisplayWeatherWPUserControl" %>
<div>
